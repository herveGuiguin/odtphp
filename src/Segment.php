 ...
 * SVN Revision: 45
 * Id: Segment.php 45 2009-06-17 10:12:59Z neveldo
 *
...
class Segment implements IteratorAggregate, Countable {
    ...
    public function merge() {
        ...
        if ($this->hasChildren()) {
            foreach ($this->children as $child) {
                $this->xmlParsed = str_replace($child->xml,
                                               ($child->xmlParsed == "") ? $child->merge() : $child->xmlParsed,
                                               $this->xmlParsed);
                $child->xmlParsed = '';
     ...
     */
    public function setImage($key, $value, $page = null, $width = null, $height = null, $offsetX = null,
                             $offsetY = null) {
...
IMG;
    ...
    public function setVars($key, $value, $encode = true, $charset = 'ISO-8859') {
        if (strpos($this->xml,
                   $this->odf->getConfig('DELIMITER_LEFT') . $key . $this->odf->getConfig('DELIMITER_RIGHT')) === false) {
